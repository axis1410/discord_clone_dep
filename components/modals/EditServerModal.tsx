...
const editServerModalFormSchema = z.object({
...
export const EditServerModal = () => {
  ...
  const form = useForm<z.infer<typeof editServerModalFormSchema>>({
  ...
  const onSubmit = async (
    values: z.infer<typeof editServerModalFormSchema>,
  ) => {
    try {
      ...
      console.error([`[ERROR EditServerModal.tsx]: ${error}`]);
    }
  };
